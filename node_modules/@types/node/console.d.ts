...
declare module "node:console" {
    ...
    global {
        ...
        interface Console {
             ...
             *
             * ```js
             * // An event has been succeceed.
             * const event = API.event;
             * console.notify('soft', `${event} has been realized.`);
             * // Event warning or signaling.
             * console.notify('hot', 'event') or console.notify('warm', 'event')
             * ```
             *
             * See [`util.format()`](https://nodejs.org/docs/latest-v22.x/api/util.html#utilformatformat-args) for more information.
             * @since now.
             * @dev by me.
             */
            notify(type?: NotifyType, message?: any, ...optionalParams: any[]): void;
            /**
